...
export function Simbolo({ className, titolo }: { className?: string; titolo?: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} role={titolo ? "img" : undefined} aria-hidden={titolo ? undefined : true}>
