// Catalogo d231. Estratto dal prototipo da `scripts/extract-seed.mjs`: non si modifica a
// mano, si rigenera. `pnpm seed:check` fallisce in CI se i file divergono dalla fonte.

import templates from "./d231-templates.json" with { type: "json" };
import demo from "./d231-demo.json" with { type: "json" };
